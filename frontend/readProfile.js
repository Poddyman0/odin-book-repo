...
function getProfileAndPosts() {
    ...
    function createComment (commentValue, postID) {
        ...
        fetch(`http://localhost:3000/socialMediaApp/post/post/${postID}/usercommentpost`, {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${userTokenSignedIn}`
    ...
    function createLike (postID) {
        ...
        fetch(`http://localhost:3000/socialMediaApp/post/post/${postID}/likepost`, {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${userTokenSignedIn}`
...
function signOutButton() {
    document.getElementById("signOut").addEventListener('click', function() {
        ...
        const signOutProfileBD ={
                    ...
                    fetch(`http://localhost:3000/socialMediaApp/user/put/signout/${userId}/passport`, {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json"
